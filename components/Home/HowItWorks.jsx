    ...
    <motion.section
      ...
      <div className='flex flex-col justify-center items-center space-y-10 max-w-7xl w-full mx-auto '>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}>
          <h1 className='text-[34px] md:text-[48px] font-[800] leading-tight text-black tracking-tight'>
            How It Works
          </h1>
          <p className='text-[16px] sm:text-[18px] text-[#4a5568] font-[400]'>
            Simple. Fast. Free.
          </p>
        </motion.div>

        {/* Steps */}
        <div className='w-full flex flex-col lg:flex-row items-center justify-center lg:justify-between space-y-8 lg:space-y-0'>
          {steps.map((step, index) => (
            <div key={index} className='flex items-center'>
              <motion.div
                ...
                {/* Icon */}
                <motion.div
                  className='w-20 h-20 bg-gray-50 rounded-[12px] flex items-center justify-center border-2 border-gray-200 mb-2'
